...
describe('Person e2e test', () => {
  ...
  it('should create and save People', async () => {
    ...
    await personUpdatePage.setBirthdateInput('birthdate');
    expect(await personUpdatePage.getBirthdateInput()).to.match(/birthdate/);
    ...
    await personUpdatePage.setNeighborhoodInput('neighborhood');
    expect(await personUpdatePage.getNeighborhoodInput()).to.match(/neighborhood/);
    ...
    await personUpdatePage.setRhInput('rh');
    expect(await personUpdatePage.getRhInput()).to.match(/rh/);
    ...
    await personUpdatePage.setRelationsInput('relations');
    expect(await personUpdatePage.getRelationsInput()).to.match(/relations/);
    await personUpdatePage.setStateCivilInput('stateCivil');
    expect(await personUpdatePage.getStateCivilInput()).to.match(/stateCivil/);
    await personUpdatePage.setProfessionInput('profession');
    expect(await personUpdatePage.getProfessionInput()).to.match(/profession/);
